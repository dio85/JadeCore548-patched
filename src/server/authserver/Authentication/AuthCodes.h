...
#define JADECORE_ACCEPTED_CLIENT_BUILD        {18414, 18273, 17898, 17399, 17371, 16135, 12340, 0}  // accept one Mists of Pandaria, one Cataclysm and one Wrath of the Lich King build
